...
describe('FormatName.js', () => {
    describe('format()', () => {
        ...
        it('should return a first name without trailing spaces when only a first name is given',
            (done) => {
        ...
        it('should return a last name without leading spaces when only a last name is given',
            (done) => {
